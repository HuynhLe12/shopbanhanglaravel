...
Route::get('/Search-page', 'App\Http\Controllers\HomeController@search');

//Category in home page
Route::get('/product-category/{category_id}', 'App\Http\Controllers\CategoryProduct@show_category_home');
Route::get('/product-brand/{brand_id}', 'App\Http\Controllers\BrandProduct@show_brand_home');
Route::get('/product-detail/{product_id}', 'App\Http\Controllers\ProductController@details_product');
